...
def run(screen, clock, font):
    ...
    def buildButtons():
        ...
        for i, label in enumerate(labels):
            rect = pygame.Rect(winW // 2 - bW // 2, startY + i * (bH + 14), bW, bH)
    ...
    while running:
                ...
                for label, rect in buttons:
                    if rect.collidepoint(mx, my):
                        ...
                        if label == "settings":
                            ...
                            if result == "quit":
                                return "quit", screen
                            buttons = buildButtons()  #rebuild with new screen size
        ...
        #title
        titleSurf = titleFont.render("nagra idk", True, theme.textPrimary)
        screen.blit(titleSurf, (winW // 2 - titleSurf.get_width() // 2, 80))
